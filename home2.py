...
def show_home2():
    ...
    st.write("""โมเดลนี้ใช้ข้อมูลภาพจาก Kaggle""")
    st.write(""": truchikakumbhar/obesity-prediction""")
    st.write("""ซึ่งมีข้อมูลของบุคคลเกี่ยวกับอายุ ส่วนสูง BMI และน้ำหนักดังนี้ : """)
    st.write("""
